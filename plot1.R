...
# reproduce first figure

GAP <- as.numeric(D1$Global_active_power)/1000 # localization treats . as , and requires division by 1000

png('Plot 1.png', width = 480, height = 480) # set dimensions of png

par(mar=c(5.1, 4.1, 4.1, 2.1)) # set margins used in tutorial videos
hist(GAP, col='red', xlab = 'Global Active Power (kilowatts)', ylab = 'Frequency', main='Global Active Power') # the plot
